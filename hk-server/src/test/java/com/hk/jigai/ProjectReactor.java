...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.hk.boot";
    private static final String ARTIFACT_ID = "hk";
    private static final String PACKAGE_NAME = "com.hk.jigai";
    private static final String TITLE = "恒科信息化技改系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.hk.boot";
        String artifactIdNew = "hk";
        String packageNameNew = "com.hk.jigai";
        String titleNew = "恒科信息化技改系统";
//        String projectBaseDirNew = projectBaseDir + "-new"; // 一键改名后，“新”项目所在的目录
        String projectBaseDirNew = "D:\\hk-jigai-platform";
