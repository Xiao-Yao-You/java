package com.hk.jigai.module.infra.service.codegen.inner;
...
import com.hk.jigai.framework.apilog.core.enums.OperateTypeEnum;
import com.hk.jigai.framework.common.exception.util.ServiceExceptionUtil;
...
import com.hk.jigai.framework.common.util.object.ObjectUtils;
...
import com.hk.jigai.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "hk-module-${table.moduleName}/" + // 顶级模块
                "hk-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "hk-module-${table.moduleName}/" + // 顶级模块
                "hk-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "hk-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "hk-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
