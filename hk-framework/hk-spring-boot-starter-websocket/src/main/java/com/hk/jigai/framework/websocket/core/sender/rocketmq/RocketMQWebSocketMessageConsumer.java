package com.hk.jigai.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${hk.websocket.sender-rocketmq.topic}",
        consumerGroup = "${hk.websocket.sender-rocketmq.consumer-group}",
