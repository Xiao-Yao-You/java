package com.hk.jigai.framework.operatelog.core.service;
...
import com.hk.jigai.module.system.api.logger.OperateLogApi;
...
public class LogRecordServiceImpl implements ILogRecordService {
    ...
    public static void fillModuleFields(OperateLogCreateReqDTO reqDTO, LogRecord logRecord) {
        ...
        reqDTO.setAction(logRecord.getAction());// 操作内容，例如：修改编号为 1 的用户信息，将性别从男改成女，将姓名从恒科改成源码。
