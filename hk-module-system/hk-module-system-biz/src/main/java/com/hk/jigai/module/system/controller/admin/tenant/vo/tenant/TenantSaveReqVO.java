package com.hk.jigai.module.system.controller.admin.tenant.vo.tenant;
...
public class TenantSaveReqVO {
    ...
    @Schema(description = "租户名", requiredMode = Schema.RequiredMode.REQUIRED, example = "恒科")
    ...
    @Schema(description = "用户账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "hk")
