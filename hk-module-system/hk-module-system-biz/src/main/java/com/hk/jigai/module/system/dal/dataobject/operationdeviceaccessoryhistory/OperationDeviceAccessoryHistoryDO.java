 ...
 * @author 邵志伟
 */
@TableName("hk_operation_device_acce_history")
@KeySequence("hk_operation_device_acce_history_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
