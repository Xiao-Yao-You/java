...
import com.hk.jigai.framework.tenant.core.util.TenantUtils;
import com.hk.jigai.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
...
import com.hk.jigai.module.system.enums.permission.RoleTypeEnum;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 hk.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
