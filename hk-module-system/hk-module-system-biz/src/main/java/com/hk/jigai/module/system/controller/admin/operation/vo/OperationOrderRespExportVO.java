...
public class OperationOrderRespExportVO {
    ...
    @DictFormat(DictTypeConstants.REPAIR_ORDER_STATUS)
    ...
    @ExcelProperty(value = "请求类型", converter = DictConvert.class)
    @DictFormat(DictTypeConstants.REPAIR_ORDER_TYPE)
...
//    @ExcelProperty("问题类型")
    ...
    @DictFormat(DictTypeConstants.HK_LEVEL)
    ...
    @ExcelProperty(value = "接单类型", converter = DictConvert.class)
    @DictFormat(DictTypeConstants.ORDER_TYPE)
    private Integer type;

    @Schema(description = "来源,00 线上报修,01 线下报修", example = "2")
    @ExcelProperty(value = "工单来源", converter = DictConvert.class)
